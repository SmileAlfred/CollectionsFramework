...
public class UIImageLoaderActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        videoController1.setUp("http://vfx.mtime.cn/Video/2019/05/23/mp4/190523092929709049.mp4", JCVideoPlayer.SCREEN_LAYOUT_LIST,
                "《哥斯拉2：怪兽之王》终极预告");
        Picasso.get()
                .load("http://img5.mtime.cn/mg/2019/05/23/092948.24252228_120X90X4.jpg")
